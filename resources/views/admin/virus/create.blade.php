<x-app-layout>
    <x-breadcrumbs name="virus.create" />
    <h1 class="font-semibold text-xl my-8">Tambah Virus</h1>
            ...
            <x-card-container>
                <div class="avatar">
                    <div class="w-full rounded rounded-xl">
                        <img src="{{ asset('images/noimage.jpg') }}" id="imageThumbnail" />
                    </div>
                </div>
        ...
        <div class="lg:w-4/5">
            <form action="{{ route('admin.virus.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <x-card-container>
                    ...
                    <x-textarea id="description" label="Deskripsi" name="description" class="ckeditor" required />
