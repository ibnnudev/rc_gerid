<x-guest-layout>
    ...
    <div class="grid lg:grid-cols-3 gap-6 mt-5">
        <div class="bg-blue-200 border border-gray-200 rounded-xl lg:col-span-2 p-6 shadow-sm">
        ...
        <div class="grid lg:grid-cols-2 gap-6 h-fit p-6 bg-white rounded-xl shadow">
