...
@section('content')
    <section class="px-5 py-2 align-top "> 
        ...
        <div class="dt-responsive table-responsive">
                ...
                <tbody>
                    ...
                    <tr>
                        <td style="width: 1;border:none" class="align-top">
                            <input class="form-check-input" type="checkbox" id="id_fasta" name="fasta[]" value="{{ $item['id_citation'] }}" class="id_fasta">
            ...
            <button class="download" id="download" type="submit" class="hover:text-blue-800">Download selected</button>
            </form>
        </div>
    </section>
@endsection
